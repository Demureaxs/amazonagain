  ...
  return (
    <header>
      <div className="flex items-center bg-amazon_blue px-4 flex-grow py-2">
        ...
        <div className=" ml-4 hidden sm:flex items-center h-10 rounded-md flex-grow cursor-pointer bg-yellow-500 hover:bg-yellow-600">
          <input
        ...
        <div className="text-white flex items-center text-xs space-x-6 mx-6 whitespace-nowrap">
          ...
          <div className=" relative link flex items-center">
            <span className="absolute top-0 right-0 md:right-10 h-4 w-4 bg-yellow-500 text-center rounded-full text-black font-semibold ">
              0
            </span>
